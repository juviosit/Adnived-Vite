...
export const docContent: Record<string, ComponentType> = {
  ...
  "integration-gtm": IntegrationGTM,
  "integration-webflow": IntegrationWebflow,
  "integration-squarespace": IntegrationSquarespace,
  "integration-wix": IntegrationWix,
  "integration-ghost": IntegrationGhost,
  "integration-hugo": IntegrationHugo,
  "integration-gatsby": IntegrationGatsby,
  "integration-drupal": IntegrationDrupal,
  "integration-joomla": IntegrationJoomla,
  "integration-spa": IntegrationSPA,
  "integration-custom": IntegrationCustom,
